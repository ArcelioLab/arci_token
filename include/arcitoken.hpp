...
namespace arci {
    ...
    class [[eosio::contract("arcitoken")]] arcitoken :public eosio::contract {

    public:
        arcitoken(eosio::name receiver, eosio::name code, eosio::datastream<const char *> ds) :
        ...
        ACTION destroy(eosio::name issuer,eosio::asset maximum_supply);
        // ACTION addsupply(eosio::asset addsupply);
